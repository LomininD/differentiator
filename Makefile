...
-Wsign-promo -Wstrict-overflow=2 -Wsuggest-override -Wundef -Wunreachable-code \
...
SRCMODULES = tree_funcs.cpp differentiator_funcs.cpp inout_funcs.cpp tree_dump.cpp reader.cpp dmath.cpp
...
deps.mk: $(SRCMODULES) $(DEBUG_MODULE)
	$(CPP) -MM $^ > $@
